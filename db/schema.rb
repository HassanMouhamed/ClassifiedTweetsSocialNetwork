...
ActiveRecord::Schema.define(version: 20160611191747) do
  ...
  add_index "likes", ["user_id"], name: "fk_user_idx", using: :btree
  ...
  add_index "notifications", ["maker_id"], name: "fk_maker_idx", using: :btree
  add_index "notifications", ["post_id"], name: "fk_post_idx", using: :btree
  add_index "notifications", ["user_id"], name: "fk_user_idx", using: :btree
  ...
  add_foreign_key "comments", "users", name: "fk_writer", on_update: :cascade, on_delete: :cascade
  ...
  add_foreign_key "notifications", "posts", name: "fk_post", on_update: :cascade, on_delete: :cascade
  add_foreign_key "notifications", "users", column: "maker_id", name: "fk_maker", on_update: :cascade, on_delete: :cascade
  add_foreign_key "notifications", "users", name: "fk_user", on_update: :cascade, on_delete: :cascade
